...
export default function Home() {
  return (
    <div>
      ...
      <div className="relative w-full h-200"> {/* h-48 = 12rem = 192px */}
        <Image
          src="/home.jpg"
          alt="Home"
          fill
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Our website offers high-quality custom-designed clothing and accessories, blending comfort with style to meet everyday fashion needs.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Our website offers high-quality custom-designed clothing and accessories, blending comfort with style to meet everyday fashion needs.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Our website offers high-quality custom-designed clothing and accessories, blending comfort with style to meet everyday fashion needs.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Our website offers high-quality custom-designed clothing and accessories, blending comfort with style to meet everyday fashion needs.</p>
          </div>
